...
pub fn get_metadata_from_file(rmid_file_path: &str) -> Result<Vec<Chunk>, Box<dyn Error>> {
...
fn get_metadata_from_rmid_chunks(rmid_file: &mut File, file_path: &str) -> Result<Vec<Chunk>, Box<dyn Error>> {
