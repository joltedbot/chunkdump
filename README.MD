...
Resource Interchange File Format (RIFF) Wave files. Other file formats may follow starting with FLAC.
...
Then point it at your .wav file with
> chunkdump /path/to/file/file.wav

#### Usage

> chunkdump [-v] [-o <output-file>] <file.wav>
